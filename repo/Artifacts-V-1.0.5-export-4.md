...
This catalog replaces the oversized startup set in v1.0.2 with a smaller baseline. The intent is to preserve decision quality while reducing duplicate planning, control, and compliance records.
