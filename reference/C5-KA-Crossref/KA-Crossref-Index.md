...
| File | Relationship |
|---|---|
| `reference/C4-Process-Records/PR##-*.md` | Detailed I/O/T&T for each process |
...
| `reference/C6-TT-Taxonomy/` | Tools & Techniques deduplicated taxonomy |
| `reference/C7-IO-Registry/` | Inputs/Outputs master artifact registry |
