...
pmbok8_source: §4 (Knowledge Areas) · Process Groups: A Practice Guide §2
...
- Its **PR number** (the reference/processes/ file in this repository)
...
**Note:** Executing processes Acquire Resources, Develop Team, and Manage Team are covered in reference/processes/ as part of the broader Executing group. PR11 appears in both Schedule and Resource KAs.
...
**Process count:** 3
**Note:** Conduct Procurements and Control Procurements are covered in reference/processes/ Executing and M&C batches. In PMBOK 8, procurement is addressed via Plan Sourcing Strategy and Appendix X4.
...
| File | Relationship |
|---|---|
| `reference/processes/PR##-*.md` | Detailed I/O/T&T for each process |
...
| `reference/tools-techniques/` (pending P0-G) | Tools & Techniques deduplicated taxonomy |
| `reference/inputs-outputs/` (pending P0-K) | Inputs/Outputs master artifact registry |

---

*Authority: PMBOK 8 Primary · Process Groups: A Practice Guide Secondary*
*Part of PMOSkills — PMI PMBOK 8 Knowledge Base*
*Migrated from C5-KA-Crossref/ — Phase 0 P0-C — 2026-06-01*
