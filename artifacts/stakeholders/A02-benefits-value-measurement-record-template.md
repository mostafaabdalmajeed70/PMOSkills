...
file_path: artifacts/stakeholders/A02-benefits-value-measurement-record-template.md
---
...
> **Usage Note:** Initiate this record during project authorization (SKL-02-01) using benefit statements from the Business Case (A01). Update the benefits baseline when planning is complete. Update benefits realization tracking at every reporting cycle. Complete the post-project handoff section (Section 5) before signing the Project Closure Record (A27). This record persists beyond project closure — hand it off to the named Benefits Owner.
...
| Record Version | [FIELD: version number of this record, e.g., 1.0] |
| Last Updated | [FIELD: date this record was last updated] |
...
| Expected Organizational Outcome | [FIELD: the high-level outcome the organization expects from this project] |

---

## Section 3 — Benefits Register

One row per identified benefit. Benefits must be traceable to project deliverables and organizational strategic objectives.

> **Type values:** Financial / Operational / Strategic / Compliance / Reputational  
> **Status values:** Not Started / In Progress / Partially Realized / Fully Realized
...
| B-004 | [FIELD: name] | [FIELD: type] | [FIELD: description] | [FIELD: deliverable(s)] | [FIELD: owner] | [FIELD: KPI] | [FIELD: baseline] | [FIELD: target] | [FIELD: method] | [FIELD: timeframe] | [FIELD: status] |
| B-005 | [FIELD: name] | [FIELD: type] | [FIELD: description] | [FIELD: deliverable(s)] | [FIELD: owner] | [FIELD: KPI] | [FIELD: baseline] | [FIELD: target] | [FIELD: method] | [FIELD: timeframe] | [FIELD: status] |

---

## Section 4 — Value Measurement Plan
...
| B-002 | [FIELD: KPI name] | [FIELD: data source] | [FIELD: how measured] | [FIELD: frequency] | [FIELD: role] | [FIELD: where results are reported] |
| B-003 | [FIELD: KPI name] | [FIELD: data source] | [FIELD: how measured] | [FIELD: frequency] | [FIELD: role] | [FIELD: where results are reported] |
| B-004 | [FIELD: KPI name] | [FIELD: data source] | [FIELD: how measured] | [FIELD: frequency] | [FIELD: role] | [FIELD: where results are reported] |
| B-005 | [FIELD: KPI name] | [FIELD: data source] | [FIELD: how measured] | [FIELD: frequency] | [FIELD: role] | [FIELD: where results are reported] |

---

## Section 5 — Benefits Realization Tracking

Update this section at every reporting cycle (A17) and at each phase gate.
...
| Post-Project Tracking Plan | [FIELD: how, when, and by whom will unrealized benefits be tracked after closure?] |
...
*Template for: A02 — Benefits and Value Measurement Record*  
*Authority: PMBOK8 Guide §2.1.2; Standard §3 Principles*  
*See definition file: `artifacts/stakeholders/A02-benefits-value-measurement-record.md`*
