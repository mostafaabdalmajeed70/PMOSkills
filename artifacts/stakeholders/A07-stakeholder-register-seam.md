...
**File Path:** `artifacts/stakeholders/A07-stakeholder-register-seam.md`
...
|---------|---------|-------------|
| §1 Stakeholder Register — Identification | All identified stakeholders using registration schema below | SKL-02-02 |
...
| Field | Description |
|-------|-------------|
| **Stakeholder ID** | Format: S-NNN (e.g., S-001) |
...
| **Interest** | What the stakeholder cares about on this project |
...
| A05 — Context Register (EEF/OPA — stakeholder history) | SKL-01-02 |
...
*Owner: Project Manager · Version Control: Living record; major re-identification triggers version increment · Change Control: SEAM changes T1–T2 per AUTHORITY-ROUTING.md*
*Last Updated: 2026-05-30 · Patch G*
